...
BASE_QUERIES = {
    ...
    "SINGLE_GROUNDING": [
        ...
        "Identify and mark all launchpads and vehicle assembly structures.",
        "Pattern recognition for spaceport launch complexes and flame trenches.",
        "Identify and mark all storage tanks and fuel depots.",
        "Locate and mark the required things asked in the query.",
        "Pattern recognition and identifying and marking storage tanks.",
        "Detect and box research campus facilities and scientific laboratories.",
        "Mark the designated safe zones and unflooded high ground.",
    ],
    "BITEMPORAL_CHANGE": [
    ...
    "MULTI_MODEL": [
        ...
        "Identify flooded villages in Assam and draw bounding boxes around inundated structures.",
        "Identify flooded villages in Assam and draw bounding boxes around inundated settlements.",
        "Detect flooded areas and draw bounding boxes around affected structures.",
        ...
        "detect the active safe zones and mark them with green color",
        "detect the active safe zones and highlight dry land",
        "identify safe evacuation zones and delineate flood boundary",
        "detect unflooded safe zones and mark them for relief operations",
        "where are the next safe zones for evacuation between these two dates",
        "find all safe zones and dry assembly hubs outside the flood perimeter",
        "mark unflooded high ground safe zones with green polygons and boxes",
    ],
}
...
PREFIXES = {
    ...
    "SINGLE_GROUNDING": [
        ...
        "Identify and mark", "Pattern recognition on", "Recognize patterns and mark",
        "Identify and box", "Locate and mark all",
    ],
    "BITEMPORAL_CHANGE": [
